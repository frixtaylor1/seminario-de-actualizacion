    ...
    authorizerHandler
      ...
      .then((response) => {
        ...
        if (authorized) {
          ...
          this.serverMessageHandler.____sendResponse(res, 402, { error: 'Unauthorized error!' });
        }
      })
      .catch((error) => {
        console.error('Error checking authorization:', error);
        this.serverMessageHandler.____sendResponse(res, 500, { error: 'Internal Server Error' });
      }).finally(() => {
